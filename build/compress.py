...
def main(gameName):
  ...
  boot = open('appengine/common/boot.js', 'r' ,encoding="utf8")
...
def filterMessages(gameName):
  ...
  f = open('appengine/%s/generated/compressed.js' % gameName, 'r' ,encoding="utf8")
  js = f.read()
  f.close()
...
def getMessages(lang):
  ...
  f = open(blocklyMsgFileName, 'r' ,encoding="utf8")
  msgs = f.readlines()
  f.close()
  return msgs
...
def language(gameName, lang):
  ...
  f = open('appengine/%s/generated/msg/%s.js' % (gameName, lang), 'w' ,encoding="utf8")
  f.write(WARNING)
  if bMsgs:
...
def generate_uncompressed(gameName):
  ...
  f = open('appengine/%s/generated/uncompressed.js' % gameName, 'w' , encoding="utf8")
  f.write("""%s
...
def generate_compressed(gameName):
  ...
  f = open('appengine/%s/generated/compressed.js' % gameName, 'w' , encoding="utf8")
  f.write(WARNING)
  f.write(script)
  f.close()
